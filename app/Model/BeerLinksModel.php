...
{
	public const SOURCE = "Pivníci.cz";
	public const BASE_URL = "http://www.pivnici.cz";
	public const SEARCH_URL = "http://www.pivnici.cz/hledat/piva/dle-data/?hledat[text]=%s";
	public const MODE = self::ONLINE;
